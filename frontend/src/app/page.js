  ...
  return (
    <>
      <div className="w-full h-auto">
        ...
        <div className="w-full h-24 md:h-28 flex items-center justify-between text-base md:text-lg">
          <Link href="/live-exam" className="w-40 md:w-44 h-10 md:h-12 bg-[#f44336] text-white flex pl-2 md:pl-3 items-center rounded-r-xl shadow-md shadow-gray-600">
            Join LIVE exam
            ...
            <div className="w-full h-auto grid grid-cols-4 gap-1 mt-1 pr-1.5 md:pr-3">
              {leaderboardData.results.map((rstudent_result, index) => (
                <div key={index} className="w-full h-auto">
                  <div className="w-full h-16 md:h-20 relative flex justify-center items-center">
                    ...
                    <div className="absolute h-5/6 aspect-square rounded-full overflow-hidden">
                      <img src={rstudent_result.img_url} alt="" className="h-full w-full object-cover" />
                    </div>
                  </div>
        ...
        <div className="mt-8 w-full px-1.5 md:px-3">
          <div className="w-full rounded-md shadow-md shadow-gray-700 bg-[#e0f2f3] p-2.5 md:p-3">
            ...
            <div className="w-full h-auto grid grid-cols-4 gap-1 mt-1">
              {monthlyStarData.map((star, index) => (
                <div key={index} className="w-full h-auto text-center">
                  <div className="w-full h-20 md:h-24 flex justify-center items-center">
                    <img src={star.img_url} alt="" className="h-[90%] aspect-square rounded-full object-cover" />
                  </div>
                  <div className="w-full h-16 md:h-12 overflow-hidden">
